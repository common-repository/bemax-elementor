...
add_action(
    ...
    $section->start_controls_section( 'bemax_scrollify_section', [
        'label' => __( 'BEMAX Scrollify' . $onlypro, 'elementor-bemax' ),
        'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
    ] );
    if ( bemax_fs()->is_not_paying() ) {
        $section->add_control( 'important_note', [
            'show_label'      => false,
            'type'            => \Elementor\Controls_Manager::RAW_HTML,
            'content_classes' => 'bemax_advertise',
            'raw'             => __( '
        <div style="text-align:center;" class="bemax_get_pro_wrapper">
          <h3 style="font-size: 22px; font-weight: 600;">Geometry Angle Option</h3>
          <p style="margin: 20px 0 30px 0;">Adds transitions between  sections when visitors uses mouse scroll.<p>
