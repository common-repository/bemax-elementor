...
add_action(
    ...
    $section->start_controls_section( 'bemax_sparkles_section', [
        'label' => __( 'BEMAX Sparkles' . $onlypro, 'elementor-bemax' ),
        'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
    ] );
    if ( bemax_fs()->is_not_paying() ) {
        $section->add_control( 'sparkles_important_note', [
            'show_label'      => false,
            'type'            => \Elementor\Controls_Manager::RAW_HTML,
            'content_classes' => 'bemax_advertise',
            'raw'             => __( '
        <div style="text-align:center;" class="bemax_get_pro_wrapper">
          <h3 style="font-size: 22px; font-weight: 600;">BEMAX Sparkles</h3>
          ...
          <p style="margin: 20px 0 30px 0;">Adds sparkles animation to sections.
          It can be used over any type of background (color, gradient, image). Highly customizable.<p>
