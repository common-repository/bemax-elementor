...
add_action(
    ...
    $section->start_controls_section( 'bemax_waterpipe_section', [
        'label' => __( 'BEMAX Waterpipe' . $onlypro, 'elementor-bemax' ),
        'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
    ] );
    if ( bemax_fs()->is_not_paying() ) {
        $section->add_control( 'waterpipe_important_note', [
            'show_label'      => false,
            'type'            => \Elementor\Controls_Manager::RAW_HTML,
            'content_classes' => 'bemax_advertise',
            'raw'             => __( '
        <div style="text-align:center;" class="bemax_get_pro_wrapper">
          <h3 style="font-size: 22px; font-weight: 600;">BEMAX Waterpipe</h3>
          ...
          <p style="margin: 20px 0 30px 0;">Adds a smoke animation over sections background (images, gradients, color).
          Effect is triggered when section is focused. Highly customizable.<p>
