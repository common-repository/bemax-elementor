...
add_action(
    ...
    $section->start_controls_section( 'bemax_geometry_angle_section', [
        'label' => __( 'BEMAX Geometry Angle' . $onlypro, 'elementor-bemax' ),
        'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
    ] );
    if ( bemax_fs()->is_not_paying() ) {
        $section->add_control( 'geometry_angle_important_note', [
            'show_label'      => false,
            'type'            => \Elementor\Controls_Manager::RAW_HTML,
            'content_classes' => 'bemax_advertise',
            'raw'             => __( '
        <div style="text-align:center;" class="bemax_get_pro_wrapper">
          <h3 style="font-size: 22px; font-weight: 600;">BEMAX Geometry Angle</h3>
          ...
          <p style="margin: 20px 0 30px 0;">Adds animated geometry shapes to section that responses to mouse movements.
          this options is a background inself, so ignores default background adjustments.
