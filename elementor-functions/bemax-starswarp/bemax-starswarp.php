...
add_action(
    ...
    $section->start_controls_section( 'bemax_starswarp_section', [
        'label' => __( 'BEMAX Stars Warp' . $onlypro, 'elementor-bemax' ),
        'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
    ] );
    if ( bemax_fs()->is_not_paying() ) {
        $section->add_control( 'starswarp_important_note', [
            'show_label'      => false,
            'type'            => \Elementor\Controls_Manager::RAW_HTML,
            'content_classes' => 'bemax_advertise',
            'raw'             => __( '
        <div style="text-align:center;" class="bemax_get_pro_wrapper">
          <h3 style="font-size: 22px; font-weight: 600;">BEMAX Starswarp</h3>
          ...
          <p style="margin: 20px 0 30px 0;">Adds stars warp effect to section that responses to mouse movements.
          It can be applied only over colored background. Highly customizable.<p>
